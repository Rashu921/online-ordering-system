    ...
    <div class="container">
      <div class="row justify-content-between gy-5">
        <div class="col-lg-5 order-2 order-lg-1 d-flex flex-column justify-content-center align-items-center align-items-lg-start text-center text-lg-start">
          <h2 data-aos="fade-up">Hello,<br>Happy shopping!</h2>
          <p data-aos="fade-up" data-aos-delay="100">Log into your account for aquick and easy Shopping experience</p>
          <div class="d-flex" data-aos="fade-up" data-aos-delay="200">
            <a href="{{url('viewAllProduct')}}" class="btn-book-a-table">Product</a>
            </div>
        </div>
        <div class="col-lg-5 order-1 order-lg-2 text-center text-lg-start">
          <img src="home/img/home.png"  alt="" data-aos="zoom-in" width="600" style="width:120%;"  height="400"data-aos-delay="10000">
        </div>
      </div>
    </div>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-4" data-aos="fade-up" data-aos-delay="100">
            <div class="why-box">
              <h3>Why Choose SmartWay</h3>
              <p>
                
We hope to provide an excellent service for our valuable customers. You can buy your needs from here as you wish. Just click select and order your choices
              </p>
            ...
            <div class="row gy-4">
              ...
              <div class="col-xl-4" data-aos="fade-up" data-aos-delay="200">
                <div class="icon-box d-flex flex-column justify-content-center align-items-center">
                  ...
                  <p>Now with the quick order link from smart way you can place your online orders within minutes</p>
                </div>
              </div><!-- End Icon Box -->
              ...
              <div class="col-xl-4" data-aos="fade-up" data-aos-delay="400">
                <div class="icon-box d-flex flex-column justify-content-center align-items-center">
                  ...
                  <p>Hello, Happy shopping! Log into your account for aquick and easy Shopping experience</p>
                </div>
              </div><!-- End Icon Box -->
